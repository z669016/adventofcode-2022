...
class DecrypterTest {
    ...
    @Test
    void mix() {
        final var decrypter = Decrypter.of(ResourceLines.list("/day20.txt", Integer::parseInt));
        decrypter.mix();
    }
    ...
    void groveCoordinates2() {
        final var decrypter = Decrypter.of(ResourceLines.list("/day20.txt", Integer::parseInt), 811589153L);
        decrypter.mix(10);
